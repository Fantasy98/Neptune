...
checkpoint = torch.load("/storage3/yuning/thesis/models/2023-01-13/y_plus_30-VARS-pr0.025_u_vel_v_vel_w_vel-TARGETS-pr0.025_flux_ResNet_NoSkip_EPOCH=29.pt")
