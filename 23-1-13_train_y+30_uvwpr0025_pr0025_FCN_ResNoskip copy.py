...
model =FCN_ResNet_NoSkip(HEIGHT,WIDTH,CHANNELS,KNSIZE,padding)
...
EPOCH = 200
model_dir = Name_Checkpoint(y_plus,var,target,normalized,EPOCH,model_name="ResNet")
...
model_dir = Name_Checkpoint(y_plus,var,target,normalized,epoch,model_name="ResNet_NoSkip")
print(f"The model will be saved to:\n {model_dir}") 
